...
const __svg_IconBaselineAlternateEmail = `
...
export class IconBaselineAlternateEmail extends Icon {
  get svg() {
    return __svg_IconBaselineAlternateEmail;
  }
}

export class IconOutlinedAlternateEmail extends Icon {
  get svg() {
    return `
