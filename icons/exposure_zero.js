...
export class IconBaselineExposureZero extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlinedExposureZero = `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M16.14 12.5c0 1-.1 1.85-.3 2.55s-.48 1.27-.83 1.7c-.36.44-.79.75-1.3.95s-1.07.3-1.7.3c-.62 0-1.18-.1-1.69-.3-.51-.2-.95-.51-1.31-.95s-.65-1.01-.85-1.7c-.2-.7-.3-1.55-.3-2.55v-2.04c0-1 .1-1.85.3-2.55.2-.7.48-1.26.84-1.69.36-.43.8-.74 1.31-.93C10.81 5.1 11.38 5 12 5c.63 0 1.19.1 1.7.29.51.19.95.5 1.31.93.36.43.64.99.84 1.69.2.7.3 1.54.3 2.55v2.04h-.01zm-2.11-2.36c0-.64-.05-1.18-.13-1.62-.09-.44-.22-.79-.4-1.06-.17-.27-.39-.46-.64-.58-.25-.13-.54-.19-.86-.19s-.61.06-.86.18-.47.31-.64.58-.31.62-.4 1.06-.13.98-.13 1.62v2.67c0 .64.05 1.18.14 1.62.09.45.23.81.4 1.09s.39.48.64.61.54.19.87.19.62-.06.87-.19.46-.33.63-.61.3-.64.39-1.09.13-.99.13-1.62v-2.66h-.01z"/></svg>`;

export class IconOutlinedExposureZero extends Icon {
  get svg() {
    return __svg_IconOutlinedExposureZero;
  }
}

export class IconRoundExposureZero extends Icon {
  get svg() {
    return __svg_IconOutlinedExposureZero;
  }
}

export class IconSharpExposureZero extends Icon {
  get svg() {
    return __svg_IconOutlinedExposureZero;
  }
}

export class IconTwotoneExposureZero extends Icon {
  get svg() {
    return `
