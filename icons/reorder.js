...
const __svg_IconOutlinedReorder = `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M3 15h18v-2H3v2zm0 4h18v-2H3v2zm0-8h18V9H3v2zm0-6v2h18V5H3z"/></svg>`;

export class IconOutlinedReorder extends Icon {
  get svg() {
    return __svg_IconOutlinedReorder;
  }
}

export class IconRoundReorder extends Icon {
  get svg() {
    return `
