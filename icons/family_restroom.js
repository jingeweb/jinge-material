...
const __svg_IconBaselineFamilyRestroom = `
...
export class IconBaselineFamilyRestroom extends Icon {
  get svg() {
    return __svg_IconBaselineFamilyRestroom;
  }
}

export class IconOutlinedFamilyRestroom extends Icon {
  get svg() {
    return __svg_IconBaselineFamilyRestroom;
  }
}

export class IconRoundFamilyRestroom extends Icon {
  get svg() {
    return `
...
export class IconSharpFamilyRestroom extends Icon {
  get svg() {
    return `
...
export class IconTwotoneFamilyRestroom extends Icon {
  get svg() {
    return __svg_IconBaselineFamilyRestroom;
  }
}