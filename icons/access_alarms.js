...
export class IconBaselineAccessAlarms extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlineAccessAlarms = `
...
export class IconOutlineAccessAlarms extends Icon {
  get svg() {
    return __svg_IconOutlineAccessAlarms;
  }
}

export class IconRoundAccessAlarms extends Icon {
  get svg() {
    return `
