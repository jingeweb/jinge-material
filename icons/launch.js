...
export class IconBaselineLaunch extends Icon {
  get svg() {
    return `
...
export class IconOutlineLaunch extends Icon {
  get svg() {
    return __svg_IconOutlineLaunch;
  }
}

export class IconRoundLaunch extends Icon {
  get svg() {
    return `
...
export class IconSharpLaunch extends Icon {
  get svg() {
    return `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M19 19H5V5h7V3H3v18h18v-9h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg>`;
  }
}

export class IconTwotoneLaunch extends Icon {
  get svg() {
    return __svg_IconOutlineLaunch;
  }
}