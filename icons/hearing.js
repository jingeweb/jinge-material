...
const __svg_IconBaselineHearing = `
...
export class IconBaselineHearing extends Icon {
  get svg() {
    return __svg_IconBaselineHearing;
  }
}

export class IconOutlinedHearing extends Icon {
  get svg() {
    return __svg_IconBaselineHearing;
  }
}

export class IconRoundHearing extends Icon {
  get svg() {
    return `
...
export class IconSharpHearing extends Icon {
  get svg() {
    return __svg_IconBaselineHearing;
  }
}

export class IconTwotoneHearing extends Icon {
  get svg() {
    return `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7.64 2.64L6.22 1.22C4.23 3.21 3 5.96 3 9s1.23 5.79 3.22 7.78l1.41-1.41C6.01 13.74 5 11.49 5 9s1.01-4.74 2.64-6.36z"/><circle cx="14" cy="9" r="2.5"/><path d="M17 20c-.29 0-.56-.06-.76-.15-.71-.37-1.21-.88-1.71-2.38-.51-1.56-1.47-2.29-2.39-3-.79-.61-1.61-1.24-2.32-2.53C9.29 10.98 9 9.93 9 9c0-2.8 2.2-5 5-5s5 2.2 5 5h2c0-3.93-3.07-7-7-7S7 5.07 7 9c0 1.26.38 2.65 1.07 3.9.91 1.65 1.98 2.48 2.85 3.15.81.62 1.39 1.07 1.71 2.05.6 1.82 1.37 2.84 2.73 3.55.51.23 1.07.35 1.64.35 2.21 0 4-1.79 4-4h-2c0 1.1-.9 2-2 2z"/></svg>`;
  }
}