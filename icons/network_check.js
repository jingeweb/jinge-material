...
export class IconSharpNetworkCheck extends Icon {
  get svg() {
    return __svg_IconOutlinedNetworkCheck;
  }
}

export class IconTwotoneNetworkCheck extends Icon {
  get svg() {
    return __svg_IconOutlinedNetworkCheck;
  }
}