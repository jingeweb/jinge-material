...
export class IconBaselinePets extends Icon {
  get svg() {
    return `
...
export class IconOutlinedPets extends Icon {
  get svg() {
    return __svg_IconOutlinedPets;
  }
}

export class IconRoundPets extends Icon {
  get svg() {
    return __svg_IconOutlinedPets;
  }
}

export class IconSharpPets extends Icon {
  get svg() {
    return __svg_IconOutlinedPets;
  }
}

export class IconTwotonePets extends Icon {
  get svg() {
    return __svg_IconOutlinedPets;
  }
}