...
export class IconBaselineSettingsInputComposite extends Icon {
  get svg() {
    return `
...
export class IconOutlineSettingsInputComposite extends Icon {
  get svg() {
    return `
...
export class IconRoundSettingsInputComposite extends Icon {
  get svg() {
    return `
...
export class IconSharpSettingsInputComposite extends Icon {
  get svg() {
    return `
