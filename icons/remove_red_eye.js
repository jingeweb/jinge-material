...
export class IconBaselineRemoveRedEye extends Icon {
  get svg() {
    return `
...
export class IconOutlineRemoveRedEye extends Icon {
  get svg() {
    return `
...
const __svg_IconRoundRemoveRedEye = `
