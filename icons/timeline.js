...
export class IconBaselineTimeline extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlinedTimeline = `
...
export class IconOutlinedTimeline extends Icon {
  get svg() {
    return __svg_IconOutlinedTimeline;
  }
}

const __svg_IconRoundTimeline = `
...
export class IconRoundTimeline extends Icon {
  get svg() {
    return __svg_IconRoundTimeline;
  }
}

export class IconSharpTimeline extends Icon {
  get svg() {
    return __svg_IconRoundTimeline;
  }
}

export class IconTwotoneTimeline extends Icon {
  get svg() {
    return __svg_IconOutlinedTimeline;
  }
}