...
export class IconBaselineEvStation extends Icon {
  get svg() {
    return `
...
export class IconOutlinedEvStation extends Icon {
  get svg() {
    return `
...
export class IconRoundEvStation extends Icon {
  get svg() {
    return `
...
export class IconSharpEvStation extends Icon {
  get svg() {
    return `
