...
export class IconBaselineShutterSpeed extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlineShutterSpeed = `
...
export class IconOutlineShutterSpeed extends Icon {
  get svg() {
    return __svg_IconOutlineShutterSpeed;
  }
}

export class IconRoundShutterSpeed extends Icon {
  get svg() {
    return `
