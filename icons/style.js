...
export class IconBaselineStyle extends Icon {
  get svg() {
    return __svg_IconBaselineStyle;
  }
}

export class IconOutlinedStyle extends Icon {
  get svg() {
    return `
