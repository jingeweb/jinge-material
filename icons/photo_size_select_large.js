...
const __svg_IconBaselinePhotoSizeSelectLarge = `
...
export class IconBaselinePhotoSizeSelectLarge extends Icon {
  get svg() {
    return __svg_IconBaselinePhotoSizeSelectLarge;
  }
}

export class IconOutlinedPhotoSizeSelectLarge extends Icon {
  get svg() {
    return __svg_IconBaselinePhotoSizeSelectLarge;
  }
}

export class IconRoundPhotoSizeSelectLarge extends Icon {
  get svg() {
    return `
...
export class IconSharpPhotoSizeSelectLarge extends Icon {
  get svg() {
    return `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M21 15h2v2h-2v-2zm0 4h2v2h-2v-2zm0-8h2v2h-2v-2zm-8-8h2v2h-2V3zm8 4h2v2h-2V7zM1 7h2v2H1V7zm16-4h2v2h-2V3zm0 16h2v2h-2v-2zM3 3H1v2h2V3zm20 0h-2v2h2V3zM9 3h2v2H9V3zM5 3h2v2H5V3zm-4 8v10h14V11H1zm2 8l2.5-3.21 1.79 2.15 2.5-3.22L13 19H3z"/></svg>`;
  }
}

export class IconTwotonePhotoSizeSelectLarge extends Icon {
  get svg() {
    return `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M17 19h2v2h-2zM1 19c0 1.1.9 2 2 2h12V11H1v8zm4.5-3.21l1.79 2.15 2.5-3.22L13 19H3l2.5-3.21zM17 3h2v2h-2zm4 8h2v2h-2zm0 4h2v2h-2zM3 3C2 3 1 4 1 5h2V3zm18 4h2v2h-2zm-8-4h2v2h-2zm8 18c1 0 2-1 2-2h-2v2zM1 7h2v2H1zm8-4h2v2H9zM5 3h2v2H5zm16 0v2h2c0-1-1-2-2-2z"/></svg>`;
  }
}