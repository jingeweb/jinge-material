...
const __svg_IconBaselinePersonSearch = `
...
export class IconBaselinePersonSearch extends Icon {
  get svg() {
    return __svg_IconBaselinePersonSearch;
  }
}

export class IconOutlinedPersonSearch extends Icon {
  get svg() {
    return `
