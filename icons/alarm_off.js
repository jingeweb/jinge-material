...
export class IconOutlinedAlarmOff extends Icon {
  get svg() {
    return __svg_IconOutlinedAlarmOff;
  }
}

export class IconRoundAlarmOff extends Icon {
  get svg() {
    return `
...
export class IconSharpAlarmOff extends Icon {
  get svg() {
    return __svg_IconOutlinedAlarmOff;
  }
}

export class IconTwotoneAlarmOff extends Icon {
  get svg() {
    return `
