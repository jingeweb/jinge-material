...
export class IconBaselineGTranslate extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlinedGTranslate = `
...
export class IconOutlinedGTranslate extends Icon {
  get svg() {
    return __svg_IconOutlinedGTranslate;
  }
}

export class IconRoundGTranslate extends Icon {
  get svg() {
    return __svg_IconOutlinedGTranslate;
  }
}

export class IconSharpGTranslate extends Icon {
  get svg() {
    return __svg_IconOutlinedGTranslate;
  }
}

export class IconTwotoneGTranslate extends Icon {
  get svg() {
    return `
