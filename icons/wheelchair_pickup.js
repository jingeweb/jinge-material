...
export class IconSharpWheelchairPickup extends Icon {
  get svg() {
    return `
...
export class IconTwotoneWheelchairPickup extends Icon {
  get svg() {
    return __svg_IconBaselineWheelchairPickup;
  }
}