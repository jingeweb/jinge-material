...
const __svg_IconBaselineInsertLink = `
...
export class IconBaselineInsertLink extends Icon {
  get svg() {
    return __svg_IconBaselineInsertLink;
  }
}

export class IconOutlinedInsertLink extends Icon {
  get svg() {
    return __svg_IconBaselineInsertLink;
  }
}

export class IconRoundInsertLink extends Icon {
  get svg() {
    return `
...
export class IconSharpInsertLink extends Icon {
  get svg() {
    return __svg_IconBaselineInsertLink;
  }
}

export class IconTwotoneInsertLink extends Icon {
  get svg() {
    return __svg_IconBaselineInsertLink;
  }
}