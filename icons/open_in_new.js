...
const __svg_IconOutlinedOpenInNew = `
...
export class IconOutlinedOpenInNew extends Icon {
  get svg() {
    return __svg_IconOutlinedOpenInNew;
  }
}

export class IconRoundOpenInNew extends Icon {
  get svg() {
    return `
...
export class IconSharpOpenInNew extends Icon {
  get svg() {
    return `
