...
export class IconBaselineSettingsInputComponent extends Icon {
  get svg() {
    return `
...
export class IconOutlinedSettingsInputComponent extends Icon {
  get svg() {
    return `
...
export class IconRoundSettingsInputComponent extends Icon {
  get svg() {
    return `
...
export class IconSharpSettingsInputComponent extends Icon {
  get svg() {
    return `
