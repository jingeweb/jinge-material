...
export class IconBaselineRingVolume extends Icon {
  get svg() {
    return `
...
export class IconOutlineRingVolume extends Icon {
  get svg() {
    return `
