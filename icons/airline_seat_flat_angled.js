...
export class IconBaselineAirlineSeatFlatAngled extends Icon {
  get svg() {
    return `
...
export class IconOutlineAirlineSeatFlatAngled extends Icon {
  get svg() {
    return `
