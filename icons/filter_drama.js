...
export class IconBaselineFilterDrama extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlineFilterDrama = `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.61 5.64 5.36 8.04 2.35 8.36 0 10.9 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM19 18H6c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4h2c0-2.76-1.86-5.08-4.4-5.78C8.61 6.88 10.2 6 12 6c3.03 0 5.5 2.47 5.5 5.5v.5H19c1.65 0 3 1.35 3 3s-1.35 3-3 3z"/></svg>`;

export class IconOutlineFilterDrama extends Icon {
  get svg() {
    return __svg_IconOutlineFilterDrama;
  }
}

export class IconRoundFilterDrama extends Icon {
  get svg() {
    return `
