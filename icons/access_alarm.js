...
export class IconBaselineAccessAlarm extends Icon {
  get svg() {
    return `
...
const __svg_IconOutlineAccessAlarm = `
...
export class IconOutlineAccessAlarm extends Icon {
  get svg() {
    return __svg_IconOutlineAccessAlarm;
  }
}

export class IconRoundAccessAlarm extends Icon {
  get svg() {
    return `
