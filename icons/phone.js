...
export class IconBaselinePhone extends Icon {
  get svg() {
    return `
...
export class IconOutlinedPhone extends Icon {
  get svg() {
    return `
...
export class IconRoundPhone extends Icon {
  get svg() {
    return `
...
export class IconSharpPhone extends Icon {
  get svg() {
    return `
...
export class IconTwotonePhone extends Icon {
  get svg() {
    return `
