...
export class IconBaselineImageSearch extends Icon {
  get svg() {
    return `
...
export class IconOutlineImageSearch extends Icon {
  get svg() {
    return `
