...
const __svg_IconBaselineBedtime = `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g><rect fill="none" height="24" width="24"/></g><g><g><path d="M12.34,2.02C6.59,1.82,2,6.42,2,12c0,5.52,4.48,10,10,10c3.71,0,6.93-2.02,8.66-5.02C13.15,16.73,8.57,8.55,12.34,2.02z"/></g></g></svg>`;

export class IconBaselineBedtime extends Icon {
  get svg() {
    return __svg_IconBaselineBedtime;
  }
}

export class IconOutlinedBedtime extends Icon {
  get svg() {
    return `
...
export class IconRoundBedtime extends Icon {
  get svg() {
    return `
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g><rect fill="none" height="24" width="24"/><rect fill="none" height="24" width="24"/></g><g><g><path d="M11.97,2.73c0.16-0.34-0.12-0.72-0.5-0.7C5.47,2.33,1,7.86,2.19,13.99c0.78,4.03,4.09,7.22,8.14,7.87 c4.07,0.66,7.77-1.14,9.87-4.15c0.21-0.31,0.04-0.75-0.33-0.79C13.13,16.16,9,8.96,11.97,2.73z"/></g></g></svg>`;
  }
}

export class IconSharpBedtime extends Icon {
  get svg() {
    return __svg_IconBaselineBedtime;
  }
}

export class IconTwotoneBedtime extends Icon {
  get svg() {
    return `
