...
const __svg_IconBaselineAdminPanelSettings = `
...
export class IconBaselineAdminPanelSettings extends Icon {
  get svg() {
    return __svg_IconBaselineAdminPanelSettings;
  }
}

export class IconOutlinedAdminPanelSettings extends Icon {
  get svg() {
    return `
