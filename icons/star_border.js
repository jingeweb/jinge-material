...
const __svg_IconBaselineStarBorder = `
...
export class IconBaselineStarBorder extends Icon {
  get svg() {
    return __svg_IconBaselineStarBorder;
  }
}

export class IconOutlinedStarBorder extends Icon {
  get svg() {
    return __svg_IconBaselineStarBorder;
  }
}

export class IconRoundStarBorder extends Icon {
  get svg() {
    return `
...
export class IconSharpStarBorder extends Icon {
  get svg() {
    return __svg_IconBaselineStarBorder;
  }
}

export class IconTwotoneStarBorder extends Icon {
  get svg() {
    return __svg_IconBaselineStarBorder;
  }
}