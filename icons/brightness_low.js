...
const __svg_IconBaselineBrightnessLow = `
...
export class IconBaselineBrightnessLow extends Icon {
  get svg() {
    return __svg_IconBaselineBrightnessLow;
  }
}

export class IconOutlinedBrightnessLow extends Icon {
  get svg() {
    return `
...
export class IconRoundBrightnessLow extends Icon {
  get svg() {
    return `
...
export class IconSharpBrightnessLow extends Icon {
  get svg() {
    return __svg_IconBaselineBrightnessLow;
  }
}

export class IconTwotoneBrightnessLow extends Icon {
  get svg() {
    return `
