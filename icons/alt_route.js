...
export class IconSharpAltRoute extends Icon {
  get svg() {
    return __svg_IconBaselineAltRoute;
  }
}

export class IconTwotoneAltRoute extends Icon {
  get svg() {
    return __svg_IconBaselineAltRoute;
  }
}