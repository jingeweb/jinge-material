...
const componentsRoute = {
  ...
  children: [{
    ...
    component: async() => (
      await import(/* webpackChunkName: "button" */ '../pages/components/button')
    ).PageButton
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "content" */ '../pages/components/content')
    ).PageContent
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "toolbar" */ '../pages/components/toolbar')
    ).PageToolbar
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "dialog" */ '../pages/components/dialog')
    ).PageDialog
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "icon" */ '../pages/components/icon')
    ).PageIcon
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "spinner" */ '../pages/components/spinner')
    ).PageSpinner
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "progress" */ '../pages/components/progress')
    ).PageProgress
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "popover" */ '../pages/components/popover')
    ).PagePopover
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "tooltip" */ '../pages/components/tooltip')
    ).PageTooltip
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "popconfirm" */ '../pages/components/popconfirm')
    ).PagePopconfirm
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "card" */ '../pages/components/card')
    ).PageCard
  }, {
    ...
    dynamic: true,
    component: async() => (
      await import(/* webpackChunkName: "list" */ '../pages/components/list')
    ).PageList
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "menu" */ '../pages/components/menu')
    ).PageMenu
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "drawer" */ '../pages/components/drawer')
    ).PageDrawer
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "badge" */ '../pages/components/badge')
    ).PageBadge
  }, {
    ...
    dynamic: true,
    component: async() => (
      await import(/* webpackChunkName: "bottombar" */ '../pages/components/bottom-bar')
    ).PageBottomBar
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "divider" */ '../pages/components/divider')
    ).PageDivider
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "subheader" */ '../pages/components/subheader')
    ).PageSubheader
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "avatar" */ '../pages/components/avatar')
    ).PageAvatar
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "snackbar" */ '../pages/components/snackbar')
    ).PageSnackbar
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "steppers" */ '../pages/components/steppers')
    ).PageSteppers
  }, {
    ...
    dynamic: true,
    component: async() => (
      await import(/* webpackChunkName: "tabs" */ '../pages/components/tabs')
    ).PageTabs
  }, {
    ...
    children: [{
      ...
      component: async() => (
        await import(/* webpackChunkName: "checkbox" */ '../pages/components/checkbox')
      ).PageCheckbox
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "radio" */ '../pages/components/radio')
      ).PageRadio
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "switch" */ '../pages/components/switch')
      ).PageSwitch
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "input" */ '../pages/components/input')
      ).PageInput
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "file" */ '../pages/components/file')
      ).PageFile
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "chips" */ '../pages/components/chips')
      ).PageChips
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "autocomplete" */ '../pages/components/autocomplete')
      ).PageAutocomplete
    }, {
      ...
      component: async() => (
        await import(/* webpackChunkName: "select" */ '../pages/components/select')
      ).PageSelect
    }]
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "highlight" */ '../pages/components/highlight')
    ).PageHighlight
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "empty" */ '../pages/components/empty')
    ).PageEmptyState
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "datepicker" */ '../pages/components/datepicker')
    ).PageDatepicker
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "pagination" */ '../pages/components/pagination')
    ).PagePagination
  }, {
    ...
    component: async() => (
      await import(/* webpackChunkName: "table" */ '../pages/components/table')
    ).PageTable
  }]
};
...
const uiElementsRoute = {
  ...
  children: [{
    ...
    component: async() => (
      await import(/* webpackChunkName: "elevation" */ '../pages/ui-elements/elevation')
    ).PageElevation
  }, {
    name: 'ui.layout',
    path: '/layout',
    ...
    component: async() => (
      await import(/* webpackChunkName: "layout" */ '../pages/ui-elements/layout')
    ).PageLayout
  }, {
    name: 'ui.typography',
    path: '/typography',
    ...
    component: async() => (
      await import(/* webpackChunkName: "typography" */ '../pages/ui-elements/typography')
    ).PageTypography
  }, {
    name: 'ui.states',
    path: '/states',
    ...
    component: async() => (
      await import(/* webpackChunkName: "states" */ '../pages/ui-elements/states')
    ).PageStates
  }]
};

export default [componentsRoute, uiElementsRoute, {
  name: 'home',
  path: '/',
  ...
  component: async() => (
    await import(/* webpackChunkName: "about" */ '../pages/about')
  ).PageAbout
}, {
  ...
  component: async() => (
    await import(/* webpackChunkName: "gettingstarted" */ '../pages/getting-started')
  ).PageGettingStarted
}, {
  name: 'i18n',
  path: '/i18n',
  ...
  component: async() => (
    await import(/* webpackChunkName: "i18n" */ '../pages/advance/i18n')
  ).PageI18N
}, {
  name: 'theme',
  path: '/theme',
  ...
  component: async() => (
    await import(/* webpackChunkName: "theme" */ '../pages/advance/theme')
  ).PageTheme
}, {
  name: 'use-router',
  path: '/use-router',
  ...
  component: async() => (
    await import(/* webpackChunkName: "userouter" */ '../pages/advance/use-router')
  ).PageUseRouter
}, {
  name: 'license',
  path: '/license',
  ...
  component: async() => (
    await import(/* webpackChunkName: "license" */ '../pages/license')
  ).PageLicense
}, {
  name: 'debug',
  path: '/debug',
  ...
  component: async() => (
    await import(/* webpackChunkName: "debug" */ '../pages/debug')
  ).PageDebug
}, {
  path: '/(.*)',
  redirect: 'home'
