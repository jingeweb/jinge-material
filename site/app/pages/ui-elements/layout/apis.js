    ...
    breakpoints: {
      ...
      props: [
        ...
        },
        {
          name: 'small',
          description: _t(
            '适用于宽度介于 600 像素到 959 像素之间的屏幕，比如中型和大型手机、纵向模式的小型和大型平板电脑以及某些台式机显示器。',
          ),
          value: '959px',
        },
        {
    ...
    layout: {
      ...
      props: [
        ...
        },
        {
          ...
          description: _t(
            '默认情况下，布局项目将始终包装在父布局下。 如果要禁用此行为，请使用此类，但是响应性将不起作用。',
          ),
        },
        {
          ...
          description:
            _t(
              '设置所有子项的对齐方式，仅当 [x] 和 [y] 同时存在时，对齐方式才有效，例如 <code>md-alignment-top-center</code>。 可能的值包括：',
            ) +
            `<br>
<ul>
  <li>top</li>
      ...
      props: [
        {
          ...
          description: _t(
            '设置元素的布局大小，按百分比计算，[amount] 可以是 33、66 或 5 的倍数，例如 <code>md-size-25</code>。',
          ),
        },
        {
          name: 'md-<code>[breakpoint]</code>-size-<code>[amount]</code>',
          description:
            _t('设置元素在特定断点下的布局大小，可能的值包括：') +
            `<br/>
<ul>
  <li>xsmall</li>
  <li>small</li>
