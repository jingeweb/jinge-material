...
<PageContainer centered _t:title="关于">
  ...
  <section class="page-container-section">
    <h2 class="md-title"><_t>项目介绍</_t></h2>
    <p>
    <_t>
      在长期的业务项目研发中，我探索并开发了一个和主流 mvvm 框架的核心都不同的 <a target="_blank" href="https://github.com/YuhangGe/jinge">Jinge</a> 框架。为了验证这个框架的能力，我决定在这个框架上开发一个 UI 组件库。
    </_t>
    </p>
    <p>
    <_t>
      考虑到主要是为了快速验证 Jinge 框架的能力，并在组件库开发的过程中同步地不断完善这个框架，而不想在组件本身的开发上耗费过多精力，我决定直接从 <a target="_blank" href="https://vuematerial.io">Vue Material</a> 这个项目分叉（Fork）。
    </_t>
    </p>
    <p>
    <_t>
    ...
    <p>
    <_t>
      Jinge Material 在移植自 Vue Material 项目的过程中，同时也参考 <a href="https://ant.design" target="_blank">Ant Design</a> 等现代组件库，对项目的目录结构和各别组件的设计进行了重构。中文相关的翻译，也大量参考了 Ant Design。特此说明。
    </_t>
    </p>
  </section>
</PageContainer>`;
